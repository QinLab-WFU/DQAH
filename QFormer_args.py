import argparse
from QFormer_config import get_config
def parse_option():
    parser = argparse.ArgumentParser('QFormer training and evaluation script', add_help=False)
    parser.add_argument('--cfg', type=str, default='configs/swin/qformer_small_patch4_window7_224.yaml', metavar="FILE", help='path to config file', )
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--resume',default='QFormer_S_patch4_window7_224.pth', help='resume from checkpoint')
    ...
    parser.add_argument("--type_of_quadruplets", type=str, default="all", help="no-miner/all/semi-hard/hard")
    parser.add_argument("--what_is_hard", type=str, default="one", help="all/one")
    parser.add_argument("--margin", type=float, default=0.25, help="margin for quadruplet loss")
